...
const conf = require('../migrations/tarifs.json')

const tarifs = conf.tarifs.map(({data}) => TarifData.create(...data))
const clientTarifs = tarifs.filter(x => !x.isPartner())
const partnerTarifs = tarifs.filter(x => x.isPartner())
